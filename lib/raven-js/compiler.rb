    ...
    def configure_sprockets(options = {})
      ...
      self.sprockets_environment = ::Sprockets::Environment.new do |env|
        ...
        env.context_class.class_eval do
          include RavenJS::Sprockets::Helpers
        end
      end
      RavenJS::Sprockets.setup(self.sprockets_environment, :vendor => !!compile_vendor)
      ...
      self.assets_dir ||= options[:assets_dir] || RavenJS.settings[:public_dir]
